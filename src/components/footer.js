    ...
    <footer className="footer text-white">
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3">
            <div className="footer-head scala-sans">About</div>
            <ul className="list-unstyled text-small">
              <li><Link to="/mission" className="text-light">About</Link></li>
              <li><Link to="/governance" className="text-light">Governance structure</Link></li>
              <li><Link to="/membership" className="text-light">Membership model</Link></li>
              <li><Link to="/impact" className="text-light">Impact</Link></li>
            </ul>
          </div>
          <div className="col-md-3">
            <div className="footer-head scala-sans">Catalog</div>
            <ul className="list-unstyled text-small">
              <li><a href="https://fulcrum.org/leverpress" className="text-light">Books</a></li>
              <li><Link to="/series" className="text-light">Series</Link></li>
              <li><Link to="/forthcoming" className="text-light">Forthcoming</Link></li>
              <li><Link to="/libraries" className="text-light">Information for libraries</Link></li>
            </ul>
          </div>
          <div className="col-md-3">
            <div className="footer-head scala-sans">Publish With Us</div>
            <ul className="list-unstyled text-small">
              <li><Link to="/authors" className="text-light">For authors</Link></li>
              <li><Link to="/peerreview" className="text-light">Peer review</Link></li>
              <li><Link to="/awards" className="text-light">Awards and prizes</Link></li>
              <li><Link to="/awards" className="text-light">Testimonials</Link></li>              
            </ul>
            <div className="footer-head scala-sans">Support Us</div>
            <ul className="list-unstyled text-small">
              <li><Link to="/oa-investment-criteria" className="text-light">Investment criteria</Link></li>
              <li><Link to="/join" className="text-light">Join us as a supporter</Link></li>
              <li><Link to="/supporters" className="text-light">Our supporters</Link></li>
            </ul>
          </div>
        </div>
        <div className="row">
